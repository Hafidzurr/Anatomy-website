...
<html lang="en">
  <head>
    ...
    <!-- <link rel="stylesheet" href="./admlayouts/listart.css"> -->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <button class="btn">
                    <i class="fas fa-plus"></i>Tambah Artikel</button></a>
						...
						?>
						  ...
						  <tbody>
						    ...
						    <td><a href="../assets/<?php echo $datasub['aset']; ?>"><?php echo $datasub['aset']; ?></a></td>
						    <td> <a href="listsubartikel.php?id=<?php echo $datasub['id']; ?>"><i class="fas fa-plus"></i> Sub Artikel</a> | <a href="frmupdateart.php?id=<?php echo $datasub['id']; ?>"><i class="fas fa-edit"></i> Update</a> | <a href="proses/deleteartikel.php?iddel=<?php echo $datasub['id']; ?>"><i class="fas fa-trash-alt"></i> Delete</a></td>
							<td>&nbsp;</td>
						    <td>
